...
board.obj: ../board.c $(GEN_OPTS) $(GEN_HDRS)
	...
	"c:/ti/ccsv6/tools/compiler/arm_5.1.5/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 --abi=eabi -me --fp_mode=strict --include_path="c:/ti/ccsv6/tools/compiler/arm_5.1.5/include" --include_path="C:/ti/tirtos_tivac_2_00_02_36/products/TivaWare_C_Series-2.1.0.12573c" -g --define=PART_TM4C1233H4PM --define=TARGET_IS_BLIZZARD_RA3 --undefine=DO_LED_TEST --undefine=DO_CHECK_BATT --display_error_number --diag_warning=225 --diag_wrap=off --preproc_with_compile --preproc_dependency="board.pp" $(GEN_OPTS__FLAG) "$<"
