...
//
//*****************************************************************************
void USBDGetStatus(void *pvInstance, tUSBRequest *psUSBRequest);
void USBDClearFeature(void *pvInstance, tUSBRequest *psUSBRequest);
void USBDSetFeature(void *pvInstance, tUSBRequest *psUSBRequest);
void USBDSetAddress(void *pvInstance, tUSBRequest *psUSBRequest);
void USBDGetDescriptor(void *pvInstance, tUSBRequest *psUSBRequest);
void USBDSetDescriptor(void *pvInstance, tUSBRequest *psUSBRequest);
void USBDGetConfiguration(void *pvInstance,
                                 tUSBRequest *psUSBRequest);
void USBDSetConfiguration(void *pvInstance,
                                 tUSBRequest *psUSBRequest);
void USBDGetInterface(void *pvInstance, tUSBRequest *psUSBRequest);
void USBDSetInterface(void *pvInstance, tUSBRequest *psUSBRequest);
void USBDSyncFrame(void *pvInstance, tUSBRequest *psUSBRequest);
void USBDEP0StateTx(uint32_t ui32Index);
void USBDEP0StateTxConfig(uint32_t ui32Index);
int32_t USBDStringIndexFromRequest(uint16_t ui16Lang,
                                          uint16_t ui16Index);
...
//
//*****************************************************************************
uint8_t g_pui8DataBufferIn[EP0_MAX_PACKET_SIZE];
...
//
//*****************************************************************************
const tStdRequest g_psUSBDStdRequests[] =
{
    USBDGetStatus,
    USBDClearFeature,
    0,
