...
.dlls,em4f .dlls: helloWorld.pem4f

-include package/cfg/helloWorld_pem4f.mak
-include package/cfg/helloWorld_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/helloWorld_pem4f.dep
endif
helloWorld.pem4f: package/cfg/helloWorld_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
helloWorld.pem4f package/cfg/helloWorld_pem4f.c: .libraries,em4f
endif

package/cfg/helloWorld_pem4f.c package/cfg/helloWorld_pem4f.h package/cfg/helloWorld_pem4f.xdl: override _PROG_NAME := helloWorld.xem4f
package/cfg/helloWorld_pem4f.c: package/cfg/helloWorld_pem4f.cfg

clean:: clean,em4f
	-$(RM) package/cfg/helloWorld_pem4f.cfg
	-$(RM) package/cfg/helloWorld_pem4f.dep
	-$(RM) package/cfg/helloWorld_pem4f.c
	-$(RM) package/cfg/helloWorld_pem4f.xdc.inc

clean,em4f::
	-$(RM) helloWorld.pem4f
.executables,em4f .executables: helloWorld.xem4f

helloWorld.xem4f: |helloWorld.pem4f

-include package/cfg/helloWorld.xem4f.mak
helloWorld.xem4f: package/cfg/helloWorld_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/helloWorld_pem4f.oem4f   package/cfg/helloWorld_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
helloWorld.xem4f: export C_DIR=
helloWorld.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
helloWorld.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

helloWorld.test test,em4f test: helloWorld.xem4f.test

helloWorld.xem4f.test:: helloWorld.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 helloWorld.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.helloWorld.xem4f, ) 
endif

clean,em4f::
	-$(RM) .tmp,helloWorld.xem4f,0,*
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
helloWorld_pem4f.oem4f,copy : package/cfg/helloWorld_pem4f.oem4f
helloWorld_pem4f.sem4f,copy : package/cfg/helloWorld_pem4f.sem4f
